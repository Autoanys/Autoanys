...
const ExecutionTableOne: React.FC = (tData) => {
  ...
  return (
    <div className="col-span-12  rounded-sm border border-stroke bg-white px-5 pb-5 pt-7.5 shadow-default hover:shadow-xl dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:col-span-8">
