    ...
    <div className=" flex h-[calc(100vh-200px)] p-4">
      {resultLoading && (
        <div className="flex h-full w-full flex-col items-center justify-center">
          <div className="border-gray-900 h-32 w-32 animate-spin rounded-full border-b-2 border-t-2"></div>
        </div>
      )}

      {!resultLoading && (
        <div className="flex h-full w-1/3  flex-col rounded-l-lg border border-slate-300 bg-white shadow-xl dark:bg-boxdark">
          <div className="p-4">
            <h2 className="mb-2 flex items-center text-xl font-bold">
              <img
                src={plugins.imageUrl}
            ...
            <button
              className="w-full rounded-l-lg bg-blue-500 p-4 px-4 py-2  text-white"
              onClick={addProfile}
            >
              Add Profile
            </button>
          ...
          <div className="mt-auto flex justify-between">
            ...
            <button
              className="w-1/2  bg-rose-600 px-4 py-2 text-white"
      ...
      {!resultLoading && (
        <div className="flex h-full w-2/3 flex-col rounded-r-lg border-b border-r border-t border-slate-300 bg-white p-4 shadow-xl dark:bg-boxdark">
