...
const MainFlowCanva = (editing, flowid) => {
  ...
  // const groupNodesByCategory = (nodes, categories) => {
  //   const groupedNodes = {};
  ...
  // const groupedNodes = groupNodesByCategory(nodeConfig, cateConfig.cate);
...
const MainFlowCanvaWrapper = () => (
  <ReactFlowProvider>
    <MainFlowCanva />
  </ReactFlowProvider>
);

export default MainFlowCanvaWrapper;
